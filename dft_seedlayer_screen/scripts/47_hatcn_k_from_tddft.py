...
def main():
    ...
    print("\n  MEASURING IT -- and what is NOT measurable. The visible k above is")
    print("  far below any transmission experiment: at 400 nm a 30 nm film absorbs")
    print("  0.02 %, and even k = 1e-3 would give only 0.07-0.09 %, against a")
    print("  UV-Vis reproducibility of 0.1-0.5 %p. Reaching 1 % absorption at")
    print("  400 nm would take a 1.5 um film. Do not try to measure visible k")
    print("  directly (an earlier version of this note claimed 30 nm sufficed for")
    print("  k = 1e-3 -- it does not, by more than an order of magnitude).")
    print("  What ellipsometry on the existing 30 nm film DOES give is n(lambda),")
    print("  which tests the n = 1.95 assumption, and the position of the")
    print("  absorption EDGE in the UV where k is of order 0.1-1 and strongly")
    print("  measurable. The edge is the dominant sensitivity here, so pinning it")
    print("  constrains the extrapolation into the visible -- which is the point,")
    print("  rather than measuring the tail itself.")
    print("  For the manuscript the operational measurement is stack transmittance")
    print("  with and without the HATCN layer, reported as 'below the X %p")
    print("  detection limit' rather than as zero.")
    print("  If sub-gap absorption is genuinely wanted, PDS reaches it; ordinary")
    print("  transmission does not.")
