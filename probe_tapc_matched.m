...
no_bar=[ones(401,1) material.l_Ag_McPeak material.l_B3_o_JO material.l_TCTA_o_JO material.l_TCTA_B3_o_JO (1.81*ones(401,1)) material.l_HATCN (1.81*ones(401,1)) material.l_HATCN (1.81*ones(401,1)) material.l_HATCN material.l_ITO_SNU_temp 1.8*ones(401,1)];
ne_bar=[ones(401,1) material.l_Ag_McPeak material.l_B3_e_JO material.l_TCTA_e_JO material.l_TCTA_B3_e_JO (1.81*ones(401,1)) material.l_HATCN (1.81*ones(401,1)) material.l_HATCN (1.81*ones(401,1)) material.l_HATCN material.l_ITO_SNU_temp 1.8*ones(401,1)];
