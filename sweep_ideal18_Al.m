...
no_bar=[ones(401,1) material.l_Al_JO (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) material.l_ITO_SNU_temp 1.8*ones(401,1)];
ne_bar=[ones(401,1) material.l_Al_JO (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) (1.8*ones(401,1)) material.l_ITO_SNU_temp 1.8*ones(401,1)];
...
save('SL_sweep_result_ideal18_ITO50_Al.mat','data_matrix','Power_matrix','EQE_SL_map','Enhancement_map','I_SL_angle', ...
