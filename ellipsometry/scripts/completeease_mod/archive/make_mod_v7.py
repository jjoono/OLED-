...
Parameters come straight from ce_pipe_result.json; no unit juggling is needed
...
OUTDIR   = _os.path.join(ELLIPS_OUT, r'mod_v7')
RESULT   = _os.path.join(ELLIPS_OUT, r'ce_pipe_result.json')
...
def main():
    ...
    for sh, rec in R.items():
        ...
        out = os.path.join(OUTDIR, NAME[sh] + '_GenOsc_v7.mod')
