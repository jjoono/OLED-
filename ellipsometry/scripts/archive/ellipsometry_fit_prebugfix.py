...
def fit_perovskite(filepath, angles_deg,
    ...
    if grahil_csv is None:
        grahil_csv = _os.path.join(ELLIPS_OUT, r'GraHIL_genosc_nk.csv')
...
PEROVSKITE_PRESETS = {
    'Perov': dict(
        ...
        depol_file=_os.path.join(ELLIPS_DATA, r'#2_depol.xlsx'),
...
if __name__ == '__main__':
    ...
    filepath = sys.argv[3] if len(sys.argv) > 3 else {
        'Bphen':  r'C:\Users\user\.claude\uploads\6fcc1f76-9a78-4f13-bf14-27ff36928edd\7a9e557e-Bphen.txt',
        'HATCN':  _os.path.join(ELLIPS_DATA, r'#1.xlsx'),
        'GraHIL': _os.path.join(ELLIPS_DATA, r'#1.xlsx'),
        'Perov':  _os.path.join(ELLIPS_DATA, r'#2.xlsx'),
        'MgAg':   _os.path.join(ELLIPS_OUT, r'MgAg1.txt'),
    }.get(material, _os.path.join(ELLIPS_OUT, r'MgAg1.txt'))

    out_base = rf'{ELLIPS_OUT}/{material}'
