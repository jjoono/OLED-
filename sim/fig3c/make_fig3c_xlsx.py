...
rows = [
 ...
 ('  ci', 'TM dissipation density per unit k_x/k0 at d_ETL = 60 nm. The plasmon peak sits at'),
 (None, 'k_x/k0 = 2.05 / 1.96 / 1.88 / 1.81 for n_e = 1.80 / 1.70 / 1.60 / 1.50: a lower'),
 (None, 'out-of-plane index moves it towards the substrate light line and weakens it.'),
