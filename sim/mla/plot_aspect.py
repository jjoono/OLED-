...
LT = np.genfromtxt(os.path.join(HERE, 'mla_aspect_lt_slice11.csv'), delimiter=',', names=True,
                   dtype=None, encoding='utf-8')
...
bx.text(1.53, 94.0, 'open: LightTools BSDF, slice 11',
        fontsize=FS_NOTE - 0.8, color='0.4', ha='right', va='top')
