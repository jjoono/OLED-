...
titles = {'A': 'A  cap, fixed base radius r, close-packed\n    (half-ellipsoid above AR = 1)',
          'B': 'B  sphere of fixed radius, cut at height h\n    (base shrinks; cylinder + hemisphere above 1)',
          'C': 'C  hemisphere scaled in height\n    (half-ellipsoid at every AR)'}
for ax, fam in zip(axs, ('A', 'B', 'C')):
    ...
    ax.set_title(titles[fam], fontsize=FS - 1.4, loc='left')
