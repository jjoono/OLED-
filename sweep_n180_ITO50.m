...
% (n_SL = n_sub = 1.80, high-index substrate: no TIR at organic/substrate), so the only free parameters are:
...
load('BSDF_SL_S_1to15by2_G_0.5to1by0.1_nSL_180.mat')   % BSDF_SL, S_list, g_list, n_SL
...
thickness=[100 500 25 10 500 3 500 3 500 3 50]; % ITO 50 nm
EML_position=4;
...
save('SL_sweep_result_n180_t500_ITO50.mat','data_matrix','Power_matrix','EQE_SL_map','Enhancement_map','I_SL_angle', ...
