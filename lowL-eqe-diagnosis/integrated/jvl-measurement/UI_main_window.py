...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Accurate EQE measurement mode (chopped low-luminance scan)
        self.aw_accurate_eqe_HLayout = QtWidgets.QHBoxLayout()
        self.aw_accurate_eqe_toggleSwitch = ToggleSwitch()
        self.aw_accurate_eqe_label = QtWidgets.QLabel("Accurate EQE Mode")
        self.aw_accurate_eqe_HLayout.addWidget(self.aw_accurate_eqe_toggleSwitch)
        self.aw_accurate_eqe_HLayout.addWidget(self.aw_accurate_eqe_label)
        self.gridLayout_3.addLayout(self.aw_accurate_eqe_HLayout, 14, 0, 1, 1)

        # Target relative precision per point for accurate EQE mode (%)
        self.aw_accurate_eqe_precision_HLayout = QtWidgets.QHBoxLayout()
        self.aw_accurate_eqe_precision_spinBox = HumbleDoubleSpinBox(
            self.aw_scrollAreaWidgetContents
        )
        self.aw_accurate_eqe_precision_spinBox.setObjectName(
            "aw_accurate_eqe_precision_spinBox"
        )
        self.aw_accurate_eqe_precision_label = QtWidgets.QLabel("Target Precision (%)")
        self.aw_accurate_eqe_precision_HLayout.addWidget(
            self.aw_accurate_eqe_precision_spinBox
        )
        self.aw_accurate_eqe_precision_HLayout.addWidget(
            self.aw_accurate_eqe_precision_label
        )
