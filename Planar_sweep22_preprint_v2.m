...
%% JO structure %%
no_bar=[ones(wavelength_num,1) material.l_Al_JO(151) 1.8 2+0.05i 1.5];
ne_bar=[ones(wavelength_num,1) material.l_Al_JO(151) 1.8 2+0.05i 1.5];
...
diag_matrix = zeros(Nd1*Nd2,9);   % v2: [d1, abs_top, abs_bottom, sub_TIR, sub_recycle_abs, sum5, nonrad, residual, Purcell]
for k1=1:length(d1)
    for k2=1:length(d2)
        ...
        disp_matrix(k_all,:)=[d1(k1),EQE_air,EQE_sub_confined,EQE_wg,EQE_spp,EQE_abs];
