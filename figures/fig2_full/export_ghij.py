...
PANELS = [('g', 'Al', 'Al'), ('h', 'Ag', 'Ag'), ('i', 'TCO + DBR', 'ITO 50 nm + chirped DBR')]
CURVES = PANELS + [('j', 'TCO + DBR, plain', 'ITO 50 nm + plain quarter-wave DBR (supplementary)')]
...
write_matrix('i_DBR_leak', 'ITO + chirped DBR: the transmitted part, 100 × T', 100*T)
