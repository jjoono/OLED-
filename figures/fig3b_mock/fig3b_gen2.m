...
%% JO structure %%
no_bar=[ones(wavelength_num,1) material.l_Al_JO(151) 1.8 1.8 1.8 1.8+0.02i 1.8];
ne_bar=no_bar;

d1= [5 10 20 30 40 50 60 80 100 120 150 180 210 250 300];  % d_ETL
Nd1=length(d1);
d2= [1.8 1.7 1.6 1.5];  % n_e of the ETL
Nd2=length(d2);
...
csvwrite('fig3b_generic_matchedTCO.csv',[ne_rows(:) disp_matrix]); toc;
