...
rows = [
 ...
 ('SI Table 1', 'real material stack, series: 88-89 % isotropic (ETL 200-300 nm), 88-89 % at Theta 0.8-0.9, 90-91 % with k_ITO 0.002.  Eq. (3) values alongside for reference.  Substrate tunnelling of the p-polarised near field (n_e,EML 1.67 < n_sub 1.8) is included.'),
 (None, None),
